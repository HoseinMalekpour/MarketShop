...
////        => optionsBuilder.UseSqlServer(" Data Source=ASHKANR2-PC2017\\ASHKAN_MAKTAB;Initial Catalog=FinalProjectDb;TrustServerCertificate=True;Integrated Security=True; ");
...
//        {
//            entity.Property(e => e.BestBidId).HasColumnName("BestBidID");
...
//            entity.HasOne(d => d.BidNavigation).WithMany(p => p.Bids)
...
//            //entity.HasOne(d => d.AppUserId).WithMany(p => p.Booths)
